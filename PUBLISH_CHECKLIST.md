...
This document tracks the steps needed to publish `@gaia/api-client` to npm.
...
- [x] Package name updated to `@gaia/api-client`
...
- [ ] Verify package appears on npm: https://www.npmjs.com/package/@gaia/api-client
